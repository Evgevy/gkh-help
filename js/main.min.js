...
var HeaderAccordion = /*#__PURE__*/function () {
  function HeaderAccordion() {
    ...
    this._breakpointMedia = window.matchMedia('(max-width: 1280px)');
...
if (window.innerWidth >= 1280) {
  $(document).ready(function () {
    $('.main-nav__link-jump').on('click', function (e) {
      e.preventDefault();
      var menu = $(this).next('.main-nav__sublist');
...
var link = document.querySelector('.main-nav__link-jump');
if (window.innerWidth >= 1280) {
...
/* harmony export */ });
var slider = document.querySelector('[data-slider="info"]');
...
$(function () {
  var stickyHeaderTop = $('.news-block').offset().top;
...
$(function () {
  var sticker = $('#sticker').offset().top;
  $(window).scroll(function () {
...
$(function () {
  var stickerMobile = $('#sticker-m').offset().top;
  $(window).scroll(function () {
...
function swiperCardTeam() {
  if (window.innerWidth <= 1050) {
    if (!team) {
      team = true;
      swiperTeam = new Swiper('.team__slider', {
        slidesPerView: 'auto',
        spaceBetween: 30,
        observer: true,
        observeParents: true,
...
$(document).ready(function () {
  if (window.innerWidth <= 1024) {
    $('.pipe-machines__link').on('click', function (e) {
      e.preventDefault();
      var menu = $(this).next('.pipe-machines__sublist');
      if (!menu.hasClass('show')) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var playButton = document.querySelector('.single-video__icon');
